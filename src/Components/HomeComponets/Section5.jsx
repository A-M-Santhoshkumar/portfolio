...
function Section5() {
  ...
  return (
    ...
    <div className="relative h-screen" ref={containerRef}>
      ...
      <div
        ref={servicesRef}
        className="container absolute top-0 left-0 w-full h-full  bg-white dark:bg-[#111] px-4 py-24 z-10"
      >
      <Title
  smallTitle="Services"
              ...
              <div className="flex flex-wrap gap-4">
                {item.icons.map((iconItem, idx) => {
                  ...
                  return (
                    <div
                      key={idx}
                      className="p-3 rounded-full bg-gray-100 dark:bg-gray-800 hover:scale-125 transition-transform"
                    >
